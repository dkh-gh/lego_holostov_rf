...
<html>
	...
	<head>
		...
		<title>Инструкция - Мусоровоз WD2</title>
	...
	<body>
		...
		<div class="page">
			...
			<div class="header">
				<h1>Инструкция - Мусоровоз WD2</h1>
			</div>
			...
			<div class="scheme">
				<div class="schemeImage" id="imgHolder">
					...
					<div class="schemeImg" style="background-image: url(20.png)"></div>
				</div>
			...
			<? $comPage = 'sh2'; include $pre.'modules/coments.php' ?>
